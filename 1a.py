...
#print k.mean()
#colors = ['b', 'g', 'r', 'c','m']
labels = ['Occupation', 'Marital_Status', 'Product_Category_1','Product_Category_2', 'Product_Category_3', 'Purchase']
#explode = (0.2, 0, 0, 0, 0, 0)
plt.pie(values,  labels=values, counterclock=False, shadow=True)
plt.title('Population Desity Index')
plt.legend(labels,loc=4)
plt.show()
#df['Occupation', 'Marital_Status'].plot.pie()